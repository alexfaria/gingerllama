...
nmap ,T :enew
nmap ,w :w!
map <silent> ,t :call ToggleVExplorer()
noremap < >
noremap > <
...
set smartcase
set softtabstop=4
set statusline=%{fugitive#statusline()}%#warningmsg#%{SyntasticStatuslineFlag()}%*%{fugitive#statusline()}%#warningmsg#%{SyntasticStatuslineFlag()}%*%{fugitive#statusline()}%#warningmsg#%{SyntasticStatuslineFlag()}%*%{fugitive#statusline()}%#warningmsg#%{SyntasticStatuslineFlag()}%*%{fugitive#statusline()}%#warningmsg#%{SyntasticStatuslineFlag()}%*
...
set shortmess=aoO
badd +40 ~/src/gingerllama/static/css/login.css
badd +42 ~/src/gingerllama/templates/login.html
badd +25 ~/src/gingerllama/templates/signup.html
badd +73 ~/src/gingerllama/app.py
badd +35 ~/src/gingerllama/models.py
args static/css/login.css
edit ~/src/gingerllama/app.py
